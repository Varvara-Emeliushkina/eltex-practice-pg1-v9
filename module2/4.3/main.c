...
int main() {
    ...
    printf("=========================================\n");
    printf("    ТЕЛЕФОННАЯ КНИГА (БИНАРНОЕ ДЕРЕВО)\n");
    printf("=========================================\n");
    ...
    do {
        ...
        switch (choice) {
            ...
            case 6: handleDisplayTree(&phonebook); break;
            case 7: handleBalanceTree(&phonebook); break;
            case 8: handleTestData(&phonebook); break;
            case 0: 
